...
module.exports = () => {
  ...
  const extra = {
    ...
    // P7.4: Gemini key intentionally NOT injected ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â client uses the server proxy.
    ...
    // Live overlay games ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â bake into extra so production Hermes can read them
    ...
    // Frenemies party game ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â ON unless explicitly disabled.
    ...
    // Reaction Duel paid skill game Ã¢â‚¬â€ ON unless explicitly disabled.
  ...
  const resolved = {
    ...
    android: {
      ...
      permissions: [
        ...
        // Incoming-call ringtone FGS (IncomingCallForegroundService) ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â mediaPlayback only.
        ...
        // Reminders use local notifications. Do NOT declare USE_EXACT_ALARM ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â
    ...
    extra,
    // Style only ÃƒÂ¢Ã¢â€šÂ¬Ã¢â‚¬Â backgroundColor/translucent map to deprecated window APIs on Android 15+.
    androidStatusBar: {
