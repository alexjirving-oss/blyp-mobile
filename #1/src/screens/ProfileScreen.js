...
import { collection, query, where, orderBy, onSnapshot, deleteDoc, doc, getDoc, getDocs } from 'firebase/firestore';
          ...
          <View style={styles.postIndicators}>
            {post.sharedTo && post.sharedTo.length > 0 && (
              <View style={styles.sharedIndicator}>
                <Icon  name="share-outline" size={12} color="#ffffff"  />
              </View>
            )}
            {post.likes > 0 && (
              <View style={styles.likeIndicator}>
                <Icon  name="heart" size={12} color="#ff1744"  />
      ...
      return (
        <View style={styles.postsGrid}>
          <View style={styles.emptyPosts}>
            <Icon  name="camera-outline" size={48} color="#374151"  />
        ...
        return (
          <View style={styles.tabContent}>
            <View style={styles.comingSoon}>
              <Icon  name="document-text-outline" size={64} color="#374151"  />
