  ...
  return (
    <View style={[style, { overflow: 'hidden', position: 'relative' }]}>
      ...
      <Video
        ...
        onLoad={(status) => {
          console.log('[EnhancedVideo] onLoad', { uri, shouldPlay, shouldLoad, status });
        }}
        onReadyForDisplay={() => {
          console.log('[EnhancedVideo] onReadyForDisplay', { uri, shouldPlay, shouldLoad });
          // existing timing + setVideoLoaded...
