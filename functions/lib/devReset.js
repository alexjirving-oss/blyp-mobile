...
exports.devResetFirestore = void 0;
const functions = __importStar(require("firebase-functions"));
const firestore_1 = require("firebase-admin/firestore");
exports.devResetFirestore = functions
    .runWith({
    timeoutSeconds: 540,
    memory: '1GB'
})
    ...
    var _a;
    // Detect environment
    const env = process.env.BLYP_ENV ||
    ...
    // Verify admin reset key
    // Support both process.env and Firebase Functions config
    const expectedKey = process.env.ADMIN_DEV_RESET_KEY ||
        ((_a = functions.config().admin) === null || _a === void 0 ? void 0 : _a.dev_reset_key);
...
//# sourceMappingURL=devReset.js.map