...
const styles = StyleSheet.create({
  ...
  vsBadge: { width: responsiveSize(44), height: responsiveSize(44), borderRadius: responsiveSize(22), backgroundColor: 'rgba(255, 45, 85,0.12)', alignItems: 'center', justifyContent: 'center', marginTop: responsiveSize(18) },
  ...
  acceptText: { color: '#FFFFFF', fontWeight: '800', fontSize: responsiveFont(15) },
