...
const styles = StyleSheet.create({
  ...
  reminderLeadChip: { flexDirection: 'row', alignItems: 'center', gap: 4, marginTop: 6, alignSelf: 'flex-start', paddingHorizontal: 8, paddingVertical: 3, borderRadius: 999, backgroundColor: 'rgba(255, 45, 85,0.10)' },
  reminderLeadText: { color: COLORS.primary, fontSize: responsiveFont(11), fontWeight: '700' },
  watchNotice: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 10, paddingHorizontal: 12, paddingVertical: 10, borderRadius: 12, backgroundColor: 'rgba(255, 45, 85,0.10)', borderWidth: 1, borderColor: 'rgba(255, 45, 85,0.35)' },
