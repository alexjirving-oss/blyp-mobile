...
To point **blyplive.com** to this Netlify site:

### 1. Log in to 123 Reg
- Navigate to: **Your Domains → blyplive.com → Manage DNS**
...
- Check status: https://www.whatsmydns.net/#A/blyplive.com
...
- [ ] Add custom domain `blyplive.com` in Netlify Dashboard
- [ ] Enable HTTPS/SSL certificate
- [ ] Test site at blyplive.com after DNS propagation
...
- [ ] Configure email forwarding for hello@blyplive.com
...
**Next Action**: Configure DNS at 123 Reg to point blyplive.com → Netlify
